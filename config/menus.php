...
return [
    ...
    'menu_8'                 =>  [
        'name'                 => 'Stem',
        'menu_icon'           => 'fas fa-ellipsis-h',
        'permissions'           => ['school-levels: list', 'schools: list', 'academic-levels: list', 'departments: list','lecturers: list','students: list','courses: list','academic-sessions: list', 'visitor: list'],
        'menu_item'            =>
        [
            [
                'title'      =>  'Schools',
