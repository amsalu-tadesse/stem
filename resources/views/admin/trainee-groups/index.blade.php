...
$('#group_id').val(trainee_group.group_id);
$('#trainee_id').val(trainee_group.trainee_id);
                ...
                $('#trainee-groups-table').on('click', '#show_row', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.success == 1) {
                                console.log(trainee_group);
                                $('#trainee_group_id').val(trainee_group.id);$('#show_modal #group_id').html(trainee_group.group_id);
$('#show_modal #trainee_id').html(trainee_group.trainee_id);
