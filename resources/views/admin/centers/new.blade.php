<x-layout>
    ...
    <x-breadcrump title='Add New Center' parent='Center' child='Add New Center' />
    <!-- /.content-header -->

    <!-- Main content -->
    <div class='card card-info'>
        <div class='card-header'>
            <h3 class='card-title'>Add Center Form</h3>
        </div>
        <!-- /.card-header -->
        <!-- general form elements -->
        <!-- form start -->
        <form id='center_form' method='POST' action="{{ route('admin.centers.store') }}">
            @csrf
            <!-- /.card-body -->
            <!-- row -->
