    ...
    <div class="modal-dialog modal-xl">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">PPD Committee Detail</h4>
            ...
            <div class="modal-body">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Current Secretariat</label>
                        <div class="col-sm-10">
                            <x-partials.textarea-input-for-show-modals name="current_secretariat" />
                        </div>
                    </div>
                    <div class="form-group row">
