    ...
    <div class='modal-dialog modal-xl'>
        ...
        <div class='modal-content'>
            <div class='modal-header'>
                <h4 class='modal-title'>Trainee Session Equipment Detail</h4>
            ...
            <div class='modal-body'>
                ...
                <div class='card-body'><div class='form-group row'>
                        <label class='col-sm-2 col-form-label'>Trainee Session</label>
                        <div class='col-sm-10'>
                            <p name='trainee_session_id' id='trainee_session_id'></p>
                        </div>
                    </div><div class='form-group row'>
                        <label class='col-sm-2 col-form-label'>Equipment</label>
                        <div class='col-sm-10'>
                            <p name='equipment_id' id='equipment_id'></p>
                        </div>
                    </div></div>
                <!-- /.row -->
                <!-- /.card-body -->
