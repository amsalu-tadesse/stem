@props(['organizationtypes', 'organizationlevels','regionLists','zoneLists'])
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Organization Type</label>
                        <div class="col-sm-10">
                            <x-partials.textarea-input-for-show-modals name="organizationType" />
                        </div>
                    </div>
                    <div class="form-group row">
