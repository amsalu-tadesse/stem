    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Update Working Group Detail</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="workingGroup_update_form">
                @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="select2-blue">
                                    <select name="organization_level_id" class="organization_level_select2 select2"
                                        data-placeholder="Pick Issue Levels" data-dropdown-css-class="select2-blue"
                                        style="width: 100%;" id="organization_level">
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <input type="hidden" name="workingGroup_id" id="workingGroup_id">
