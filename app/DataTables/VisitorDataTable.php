...
class VisitorDataTable extends DataTable
{
    ...
    {
         $query = $model::leftJoin('institutions', 'institution_id', '=', 'institutions.id')
                  ->leftJoin('institution_types', 'institution_type_id', '=', 'institution_types.id')
                  ...
                  ->select([
                      ...
                      \DB::raw("DATE_FORMAT(visitors.appointment_date, '%Y-%m-%d') AS appointment_date"),
    ...
    {
        return [Column::computed('no')->title('No')->exportable(false)->addClass('text-center')->orderable(false), Column::make('institutionName')->title('Institution'), Column::make('institutionTypeName')->title('Institution Type'), Column::make('countryName')->title('Country'), Column::make('visitor_count')->title('Expected Visitors'), Column::make('actual_visitor')->title('Actual Visitors'), Column::make('appointment_date'), Column::make('created_from'), Column::computed('action')->exportable(false)->printable(true)->addClass('text-center')->orderable(false), Column::make('created_at')->visible(false)];
    }
