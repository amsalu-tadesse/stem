...
class TrainerDataTable extends DataTable
{
        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($trainer) {
                return view('components.action-buttons', [
                    'row_id' => $trainer->id,
                    'show' => true,
                    'permission_delete' => 'trainer: delete',
                    'permission_edit' => 'trainer: edit',
                    'permission_view' => 'trainer: view',
                ]);
            })
     ...
     */
    public function query(Trainer $model): QueryBuilder
    {
