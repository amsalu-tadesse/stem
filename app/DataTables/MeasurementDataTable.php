...
class MeasurementDataTable extends DataTable
{
        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($measurement) {
                return view('components.action-buttons', [
                    ...
                    'show'=>true,
                    'permission_delete'=>'measurement: delete',
                    'permission_edit'=>'measurement: edit',
                    'permission_view'=>'measurement: view',
                ]);
            })
     ...
     *
     * @param \App\Models\Measurement $model
...
Column::make('description'),
    ...
    {
        return "measurements". date('YmdHis');
    }
}
