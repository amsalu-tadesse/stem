...
class SubscriptionsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($subscription) {
                return view('components.action-buttons-for-subscription', [
                    'row_id' => $subscription->id,
                    'permission_delete'=>'subscription: delete',
                     'permission_edit'=>'subscription: edit',
                     'permission_view'=>'subscription: view',
                ]);
            })
    ...
    public function query(Subscription $model): QueryBuilder
    {
        ...
        return $model::leftjoin('organization_levels', 'level', '=', 'organization_levels.id')
        ->select([
            'subscriptions.id',
            'subscriptions.email',
            'subscriptions.created_at','organization_levels.name As level'
        ]);
    }
    ...
    public function getColumns(): array
    {
        return [
            Column::computed('no')->title('No')
                ...
                ->orderable(false),
            Column::make('email'),
            Column::make('level')->title('Federal | Regional | Zonal'),
