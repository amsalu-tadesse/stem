...
class ProjectStatusDataTable extends DataTable
{
        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($projectstatus) {
                return view('components.action-buttons', [
                    'row_id' => $projectstatus->id,
                    'permission_delete' => 'projectStatus: delete',
                    'permission_edit' => 'projectStatus: edit',
                    'permission_view' => 'projectStatus: view',
                ]);
            })
    ...
    {
        return $this->builder()
            ->setTableId('projectstatus-table')
    ...
    {
        return 'Projectstatus' . date('YmdHis');
    }
}
